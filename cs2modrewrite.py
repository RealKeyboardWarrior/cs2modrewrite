...
parser.add_argument('-c', dest='c2server', help='C2 Server without protocol (192.168.20.20)', required=True)
...
#RewriteCond %{{HTTPS}} off [OR]
#RewriteCond %{{HTTPS}}:s on:(s) 
#RewriteRule ^.*$ "http%1://{c2server}%{{REQUEST_URI}}" [E=backend_name:c2,P,L]
''' + staging + '''
